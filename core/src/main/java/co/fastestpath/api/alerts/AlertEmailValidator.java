...
class AlertEmailValidator {
  ...
  private static final ImmutableList<String> DEV_SENDERS = ImmutableList.of(
      "John Pucciarelli <john.pucciarelli@gmail.com>",
      "Andrew Allison <andrewrobertallison@gmail.com>"
  );
